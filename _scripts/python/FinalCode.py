...
img_path = 'E:\\RS\\inverse rendering\\ModelNet10\\Train\\'
vox_path = 'E:\\RS\\inverse rendering\\volumetric_data\\ModelNet10\\Train\\'
...
history =cvae.fit_generator(Generator(batch_size,vox_path,img_path), steps_per_epoch =1000, epochs =50)
